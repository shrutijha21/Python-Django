...
SECRET_KEY = 'django-insecure-46%j8gbr8jz@m2a0z$!&a989=4!4=3&b6m1hw%^bx=m)39)i2^'
...
MEDIA_ROOT= BASE_DIR /"uploads"#tells the path where all the files are stored because of filefield
